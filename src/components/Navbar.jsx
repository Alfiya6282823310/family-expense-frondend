  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#"><img src="https://tse2.mm.bing.net/th?id=OIP.UEvGLS_dvg5bZJTwSyZrZgAAAA&pid=Api&P=0&h=220" alt="Logo" width="30" height="24" class="d-inline-block align-text-top"/>Add Expense</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Datewise search</a></li>
